function dy = Combined_Pathway_Model_Lipid(t,y,param_list,opt_struct)
...
dy(4,:) = k2_3r.*y(89,:) - k2_3f.*y(88,:).*y(4,:)...
    ...
    +LpxD.*A_kcat10./(1+y(307,:)./ki2).*y(314,:).*y(44,:)./(Kma4.*Kmb4+y(314,:).*Kmb4+y(44,:).*Kma4+y(314,:).*y(44,:))...
    +LpxA.*A_kcat.*UDP_Glc.*y(44,:)./(Kma.*Kmb+UDP_Glc.*Kmb+y(44,:).*Kma+UDP_Glc.*y(44,:))...
    +A_kcat7.*LpxL.*y(316,:).*y(36,:)./((Km3+y(316,:).*(km_laur+y(36,:))))...
    +A_kcat8.*LpxM.*y(313,:).*y(46,:)./((Km4+y(313,:).*(km_myr+y(46,:))))...
    -LpxA.*A_kcat1.*y(310,:).*y(4,:)./(Kma1.*Kmb1+y(310,:).*Kmb1+y(4,:).*Kma1+y(310,:).*y(4,:))...
    +kcatP1.*PlsB.*G3P.*y(56,:)./((KmP1+G3P).*(KmP2+y(56,:)))...
    +kcatP2*PlsC.*y(320,:).*y(61,:)./((KmP4 + y(320,:)).*(KmP5 + y(61,:)))...
    +kcatP1.*PlsB.*G3P.*y(71,:)./((KmP1+G3P).*(KmP3+y(71,:)))...
    +kcatP2*PlsC.*y(320,:).*y(71,:)./((KmP4 + y(320,:)).*(KmP6 + y(71,:)))...
    ;
...
dy(71,:) =  kcat6(8).*y(274,:)+ k7_1r(8).*y(275,:)+ k8_1r(8).*y(276,:)+ k10_1r(8).*y(281,:) - k7_1f(8).*e7.*y(71,:)- k8_1f(8).*e8.*y(71,:)- k10_1f(8).*e10.*y(71,:)- k3_4f(8).*e3.*y(71,:)+ k3_4r(8).*y(269,:)- k3_5f(8).*y(91,:).*y(71,:)+ k3_5r(8).*y(270,:)...
            -kcatP1.*PlsB.*G3P.*y(71,:)./((KmP1+G3P).*(KmP3+y(71,:))) - kcatP2*PlsC.*y(320,:).*y(71,:)./((KmP4 + y(320,:)).*(KmP6 + y(71,:)));
...
%LipidA Reactions
dy(305,:)=-k15.*y(305,:).*y(318,:)-k16.*y(305,:).*y(309,:)+k18.*y(315,:)+k19.*(FtsH_init-y(305,:)-y(315,:));
dy(306,:)=k1.*promote-k11.*y(306,:)-k14.*y(306,:).*y(315,:);
dy(307,:)=-LpxH.*A_kcat3.*y(307,:)./((Km1+y(307,:)).*(1+y(312,:)./Ki))-LpxB.*A_kcat4.*y(307,:).*y(312,:)./(Kma2.*Kmb2+y(307,:).*Kmb2+y(312,:).*Kma2+y(307,:).*y(312,:))+LpxD.*A_kcat10./(1+y(307,:)./ki2).*y(314,:).*y(44,:)./(Kma4.*Kmb4+y(314,:).*Kmb4+y(44,:).*Kma4+y(314,:).*y(44,:));
dy(308,:)=k12.*promot-k13.*y(308,:)-k17.*y(308,:).*(FtsH_init-y(305,:)-y(315,:));
dy(309,:)=A_kcat8.*LpxM.*y(313,:).*y(46,:)./((Km4+y(313,:).*(km_myr+y(46,:))))-A_kcat9.*MsbA.*y(309,:)./(Km5+y(309,:))-y(308,:).*A_kcat11.*CMP_KDO.*y(309,:)./(Kma5.*Kmb5+CMP_KDO.*Kmb5+y(309,:).*Kma5+CMP_KDO.*y(309,:));
dy(310,:)=LpxA.*A_kcat.*UDP_Glc.*y(44,:)./(Kma.*Kmb+UDP_Glc.*Kmb+y(44,:).*Kma+UDP_Glc.*y(44,:))-LpxA.*A_kcat1.*y(310,:).*y(4,:)./(Kma1.*Kmb1+y(310,:).*Kmb1+y(4,:).*Kma1+y(310,:).*y(4,:))-A_kcat2.*y(306,:).*y(310,:)./(Km+y(310,:));
dy(311,:)=A_kcat5.*LpxK.*y(318,:)./(Km2+y(318,:))-y(308,:).*A_kcat6./(1+y(309,:)./ki1).*CMP_KDO.*y(311,:)./(Kma3.*Kmb3+CMP_KDO.*Kmb3+y(311,:).*Kma3+CMP_KDO.*y(311,:));
dy(312,:)=LpxH.*A_kcat3.*y(307,:)./((Km1+y(307,:)).*(1+y(312,:)./Ki))-LpxB.*A_kcat4.*y(307,:).*y(312,:)./(Kma2.*Kmb2+y(307,:).*Kmb2+y(312,:).*Kma2+y(307,:).*y(312,:));
dy(313,:)=A_kcat7.*LpxL.*y(316,:).*y(36,:)./((Km3+y(316,:).*(km_laur+y(36,:))))-A_kcat8.*LpxM.*y(313,:).*y(46,:)./((Km4+y(313,:).*(km_myr+y(46,:))));
dy(314,:)=A_kcat2.*y(306,:).*y(310,:)./(Km+y(310,:))-LpxD.*A_kcat10./(1+y(307,:)./ki2).*y(314,:).*y(44,:)./(Kma4.*Kmb4+y(314,:).*Kmb4+y(44,:).*Kma4+y(314,:).*y(44,:));
dy(315,:)=k15.*y(305,:).*y(318,:)-k18.*y(315,:);
dy(316,:)=y(308,:).*A_kcat6./(1+y(309,:)./ki1).*CMP_KDO.*y(311,:)./(Kma3.*Kmb3+CMP_KDO.*Kmb3+y(311,:).*Kma3+CMP_KDO.*y(311,:))-A_kcat7.*LpxL.*y(316,:).*y(36,:)./((Km3+y(316,:).*(km_laur+y(36,:))));
dy(317,:)=A_kcat9.*MsbA.*y(309,:)./(Km5+y(309,:));
dy(318,:)=LpxB.*A_kcat4.*y(307,:).*y(312,:)./(Kma2.*Kmb2+y(307,:).*Kmb2+y(312,:).*Kma2+y(307,:).*y(312,:))-A_kcat5.*LpxK.*y(318,:)./(Km2+y(318,:));
dy(319,:)=y(308,:).*A_kcat11.*CMP_KDO.*y(309,:)./(Kma5.*Kmb5+CMP_KDO.*Kmb5+y(309,:).*Kma5+CMP_KDO.*y(309,:));


%Phospholipid Reactions
dy(320,:) = kcatP1.*PlsB.*G3P.*y(56,:)./((KmP1+G3P).*(KmP2+y(56,:))) + kcatP1.*PlsB.*G3P.*y(71,:)./((KmP1+G3P).*(KmP3+y(71,:)))...
            -kcatP2*PlsC.*y(320,:).*y(61,:)./((KmP4 + y(320,:)).*(KmP5 + y(61,:))) - kcatP2*PlsC.*y(320,:).*y(71,:)./((KmP4 + y(320,:)).*(KmP6 + y(71,:)));
dy(321,:) = kcatP2*PlsC.*y(320,:).*y(61,:)./((KmP4 + y(320,:)).*(KmP5 + y(61,:))) + kcatP2*PlsC.*y(320,:).*y(71,:)./((KmP4 + y(320,:)).*(KmP6 + y(71,:)));
