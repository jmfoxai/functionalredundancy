...
%p_vec = [142473.7238 7597.676912 4.276689943 40213.92919 88.88525384 1 4.645634978 0.006677519 0.284982219 -0.285700283 3.348915642 2.886607673 15.90426225 2180.050007];
...
%Options:
%plotopt = 'off' for no plot
%plotopt = 'unsaturated' for the fatty acid distribution of chain lengths
...
if strcmp(barplot,'unsaturated')
    ...
    y_bar = cat(1,dist_total,fit_dist);
    b = bar(y_bar');
    b(1).FaceColor = 'b';
    b(2).FaceColor = 'k';
